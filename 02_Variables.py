...
dec1, dec2, dec3, dec4 = 8, 42, -3, 2525852554525222554522554525
print(dec1, dec2, dec3, dec4, sep=' || ')
# числа в шестнадцатеричной системе счисления
hex1, hex2, hex3, hex4 = 0x9, 0xA, 0xFF, 0x3de
print(hex1, hex2, hex3, hex4, sep=' || ')
...
import math  # импротируем модуль math  (обычно импорт производится в верхней строчке файла)
x = 3.265
